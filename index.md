...
venue: "Online, Zoom"        # brief name of host site without address (e.g., "Euphoric State University")
...
humandate: "Tue 6th Nov, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["David Guzman", "Evan", "Peter Kiraly"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Peter Kiraly"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["d.guzman@ucl.ac.uk", "pkiraly@gwdg.de", "evan.irving-pease@arch.ox.ac.uk"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
